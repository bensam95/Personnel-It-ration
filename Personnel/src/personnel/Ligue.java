...
public class Ligue implements Serializable, Comparable<Ligue>
{
	...
	/**
	 * Retourne la date de création de la ligue.
	 * @return la date de création de la ligue.
	 */
	...
	/**
	 * Change la date de création de la ligue.
	...
	public Employe addEmploye(String nom, String prenom, String mail, String password, LocalDate dateEmbauche, LocalDate dateFinContrat)
	{
	    // Utilise le constructeur avec dates, en passant la date du jour pour l'embauche et null pour la fin de contrat
	    Employe employe = new Employe(this.gestionPersonnel, this, nom, prenom, mail, password, LocalDate.now(), null);
